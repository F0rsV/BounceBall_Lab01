public class SymbolsWithSync implements Runnable{
    ...
    public SymbolsWithSync(char symbol, SymbolThreadsSynchronizer inSymbolThreadsSynchronizer, SymbolThreadsSynchronizer outSymbolThreadsSynchronizer) {
        _symbol = symbol;
